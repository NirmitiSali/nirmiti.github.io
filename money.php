                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="color : black;">
                                    ...
                                    <td><a href="users.php?id= <?php echo $rows['id']; ?>"> <button class="btn btn-outline-dark btn">Transfer Credit</button></a></td>
                                </tr>
                            <?php
                            }
                            ?>
    ...
    <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: grey;text-align:center;color:white;">
                © 2021 Copyright - Made by <strong>Nirmiti Sali</strong> :
